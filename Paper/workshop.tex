...
Our experiments examine how DGVH could be used to create a DHT and how well it would perform in this task
...
Experiments demonstrated that DGVH is sufficiently accurate to build a P2P network which can route accurately.%TODO: Delete this
