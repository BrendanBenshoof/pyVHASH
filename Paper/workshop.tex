...
A node in the network is a candidate to go to sleep if and only if its on the boundary of the network and it Voronoi vertices are covered by other nodes.
