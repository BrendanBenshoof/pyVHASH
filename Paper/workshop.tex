...
To test the accuracy of our algorithim, we have generated the graphs produced DGVH and a Delunay triangulation generated by the Triangle\cite{shewchuk96b} library.

We tested in 2-dimensional euclidian space and measured the number of edges in the DGVH that differ from the Delunary Triangulation.

We tested groups of 5000, 2000, 1000, 500, and 100 points and found that DGVH graphs differed from the Deulnay Triangulation by approximately 1 edge per node.
